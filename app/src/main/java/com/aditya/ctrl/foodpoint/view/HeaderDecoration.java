...
/**
 * Created by Aditya on 4/27/2016.
 */
...
public class HeaderDecoration extends RecyclerView.ItemDecoration {
        ...
        if (mShadowSize > 0) {
            ...
            mShadowPaint.setShader(mHorizontal ?
                    new LinearGradient(mShadowSize, 0, 0, 0,
                            new int[]{Color.argb(50, 0, 0, 0), Color.argb(50, 0, 0, 0), Color.argb(3, 0, 0, 0)},
                            new float[]{0f, .5f, 1f},
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder parallax(@FloatRange(from = 0f, to = 2f) float parallax) {
            mParallax = parallax;
            return this;
        }
